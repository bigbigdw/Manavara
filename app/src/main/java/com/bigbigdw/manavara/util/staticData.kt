...
val menuListManavara = arrayListOf(
    ...
    MenuInfo(needLine = false, image = R.drawable.ic_launcher, menu = "공유된 웹소설 PICK 보기", body = "다른 사람이 엄선한 웹소설 작품들 보기"),
    ...
    MenuInfo(needLine = false, image = R.drawable.ic_launcher, menu = "공유된 웹툰 PICK 보기", body = "다른 사람이 엄선한 웹툰 작품들 보기"),
...
//    MenuInfo(needLine = false, image = R.drawable.ic_launcher, menu = "나의 기록", body = "https://m.comic.naver.com/event/yearend/2023"),
    ...
    MenuInfo(needLine = false, image = R.drawable.ic_launcher, menu = "최신화 현황판", body = "공지사항 및 알림 등 메세지 확인"),
)
